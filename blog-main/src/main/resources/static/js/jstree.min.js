    ...
    if (!a.jstree) {
        ...
        a.jstree = {
            ...
            plugin: function (b, c) {
                ...
                for (f.a_attr.id || (f.a_attr.id = f.id ), b.setAttribute("aria-selected", !!f.state.selected), b.setAttribute("aria-level", f.parents.length), b.setAttribute("aria-labelledby", f.a_attr.id), f.state.disabled && b.setAttribute("aria-disabled", !0), k = 0, l = f.children.length; l > k; k++) if (!p[f.children[k]].state.hidden) {
                    v = !0;
                    break
                }
        ...
        j.className = "jstree-icon jstree-checkbox", j.setAttribute("role", "presentation"), a.jstree.defaults.checkbox = {
            ...
            a.vakata.context = {
                ...
                var d = !1;
                c.element = a("<ul class='vakata-context' style='z-index: 10000'></ul>"), c.element.on("mouseenter", "li", function (b) {
